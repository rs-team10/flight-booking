...
import com.tim10.service.AirlineServiceImpl;
...
public class AirlineController {
	...
	//============================================
	//Dodato samo za registraciju hotela (sys admin)
	@RequestMapping(
			value="api/airlines/registerAirline",
			method=RequestMethod.POST, 
			consumes="application/json")
	public ResponseEntity<?> registerAirline(@RequestBody Airline airline){
